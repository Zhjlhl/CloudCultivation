...
<div class="content">
    ...
    <div class="button-container">
        <a href="${pageContext.request.contextPath}/toBuyGoods?userId=${user.id}&goodsId=${goods.id}">确认购买</a>
        <a href="${pageContext.request.contextPath}/toBuy?userId=${user.id}&index=1">取消购买</a>
    </div>
</div>
</div>
    </div>
