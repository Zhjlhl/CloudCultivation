    ...
    <style>
        ...
        *{
        ...
        input[type="button"] {
            ...
            cursor: pointer;
            margin-top: 10px;
            width: 200px; /* Add this line to set the width */
        }
...
<div class="content">
    <div class="center-content">
        <p>您的余额不足，请先完成余额充值。</p>
        <form action="${pageContext.request.contextPath}/toCharge" method="post">
            <label for="amount">充值金额:</label>
            <input type="number" name="amount" id="amount" required>
            <br>
            <input type="hidden" name="userId" id="userId" value="${user.id}"><br>
            <input type="submit" name="operate" value="我已完成支付">
            <a href="${pageContext.request.contextPath}/toUserHome">
                <input type="button" value="取消支付">
            </a>
        </form>
        <img src="${pageContext.request.contextPath}/customer/img/pay.png" alt="充值二维码">
    </div>
</div>
    </div>
</div>
