...
<div class="content">
    <div class="header">
        <form action="${pageContext.request.contextPath}/selectBySearch">
            <input type="text" name="name" placeholder="请输入需要搜索的商品名称">
...
<table>
    ...
    <c:forEach items="${goods}" var="good">
        <tr>
            ...
            <td>${good.price}</td>
            <td><form>
                <a href="${pageContext.request.contextPath}/toAdopt?userId=${user.id}&goodsId=${good.id}"><input type="button" class="pagination button"value="购买" onclick="handleBuyClick('${good.id}')"></a>
